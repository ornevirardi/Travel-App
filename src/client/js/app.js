...
async function updateUI() {
  ...
  try {
    ...
    document.getElementById("maxtemp").innerHTML = `Forecast Max Temperature: ${allData.maxTemp}`;
    console.log(allData.max_temp);
    document.getElementById("mintemp").innerHTML = `Forecast Min Temperature: ${allData.minTemp}`;
